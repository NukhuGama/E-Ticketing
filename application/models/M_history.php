...
class M_history extends CI_Model
{
    ...
    public function getRole_hist()
    {
        ...
        r.requestform_name, r.role_access, r.remark, r.is_deleted,  r.iby, r.idt, r.uby, r.udt,  r.status_req, s.status_desc 
        FROM tbl_employee e, tbl_request_log r, tbl_requeststatus s WHERE (e.nik = r.iby AND r.status_req=s.status_req) ORDER BY r.idt");
        return $query->result();
    }
    ...
    // Insert Data For adding Request Rle
