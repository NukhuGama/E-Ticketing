...
<head>
    <meta charset="utf-8">
    <title>Approval Request Tools</title>
                        ...
                        <?php foreach ($query as $data) { ?>
                            ...
                            <?php if (($this->session->userdata('nik') == '20002') && ($data->status_req == 1)) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $data->personalarea ?></td>
                                    ...
                                    <td>
                                        <div class="" style="width:100px">
                                            ...
                                            <?php if ($data->status_req == 1) { ?>
                                                <form action="<?php echo site_url('detail_approval') ?>" method="post">
                                    ...
                                    <td>
                                        <div class="" style="width:100px">
                                            ...
                                            <?php } elseif ($data->status_req == 4) { ?>
                                                <form action="<?php echo site_url('print_approval') ?>" method="post">
                                                    <input type="hidden" name="idR" value="<?php echo $data->id ?>">
