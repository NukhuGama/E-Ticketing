...
<body data-new-gr-c-s-check-loaded="8.876.0" data-gr-ext-installed="">
    <!-- Display the current url in header -->
    ...
    <table style=" border-collapse:separate;  border-spacing: 0 5px;">
        <tr>
            ...
            <th style="background-color: #000; color: antiquewhite; font-size: 25px; width:450px ">ROLE ACCESS FORM</th>
        </tr>
    ...
    <table class="app_desc" id="" style="margin-right: 16px;">
        ...
        <tr>
            <td style="width: 200px;">Application Name</td>
            <td style="width: 10px;">:</td>
            <td><?= $query['req_name'] ?></td>
        </tr>
        <tr>
            <td style="width: 200px;">Role Accessibility</td>
            <td style="width: 10px;">:</td>
            <td style="height: 100px;">
                <?php if ($query['role_access'] == 1) {
                    echo ("Access Role Request Tools(Project)");
                } elseif ($query['role_access'] == 2) {
                    echo ("Access Role Approval");
                } ?>
            </td>
        </tr>
        <tr>
    ...
    <table class="approval_tb" id="">
        <tr>
            <th colspan="5" style="background-color: #000; color: antiquewhite;">APPROVAL</th>

        </tr>
        <tr>
            <td colspan="5" style="text-align: center;">Dili , <?php echo date("d-M-Y"); ?></td>
