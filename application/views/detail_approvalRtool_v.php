    ...
    <div class="main-content app-content">
        ...
        <div class="container" style=" margin-top:40px; ">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <?php if ($query['status_req'] == 1) { ?>
                    <form action="<?= site_url('approval_r_tool/rejectedManagerUser') ?>" method="post">
                    ...
                    <form action="<?= site_url('approval_r_tool/approvalManagerUser') ?>" method="post">
                ...
                <?php } elseif ($query['status_req'] == 2) { ?>
                    <form action="<?= site_url('approval_r_tool/rejectedManagerIT') ?>" method="post">
                    ...
                    <form action="<?= site_url('approval_r_tool/approvalManagerIT') ?>" method="post">
                ...
                <?php } elseif ($query['status_req'] == 3) { ?>
                    <form action="<?= site_url('approval_r_tool/rejectedVP_NIT') ?>" method="post">
                    ...
                    <form action="<?= site_url('approval_r_tool/approvalVP_NIT') ?>" method="post">
